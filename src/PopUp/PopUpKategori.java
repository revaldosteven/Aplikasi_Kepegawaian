...
public class PopUpKategori extends javax.swing.JFrame {
    ...
    void autoID() {
        try {
            ...
            String id = kt.autoID(); // Memanggil method autoID() dari class Kategori
    ...
    private void btnTambahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTambahActionPerformed
        try {
            Kategori kt = new Kategori();
            kt.setId_kategori(txtIDKategori.getText());
            kt.setNama_kategori(txtNamaKategori.getText());
...
//        loadTable();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopUpKategori().setVisible(true);
            }
        });
    }
